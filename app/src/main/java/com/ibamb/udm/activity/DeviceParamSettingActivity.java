...
public class DeviceParamSettingActivity extends AppCompatActivity {
            ...
            switch(v.getId()){
                ...
                case R.id.menu_connect_setting:
                    ...
                    if(connectSettingFragment==null){
                        connectSettingFragment = ConnectSettingFragment.newInstance("connecting setting",null);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String hostAddress = (String)bundle.get("HOST_ADDRESS");
        String hostMac = (String)bundle.get("HOST_MAC");
        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
        hideAllFragment(transaction);
        if(ipSettingFragment ==null){
            ipSettingFragment = IPSettingFragment.newInstance("ip setting",null);
